    ...
    return (
        <footer>
            <div className="flex justify-center items-center text-white h-40">
                <div className="bg-[#1F2937] w-full h-full pr-24 flex flex-col items-end justify-center">
                ...
                <div className="bg-[#111827] w-full pl-24 h-full flex flex-col justify-center">
                    <span className="footer-title">Follow US</span>
                    <a className="link link-hover mb-5">Join us on social media</a>
